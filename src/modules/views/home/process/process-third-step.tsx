...
const ProcessThirdStep: React.FC<IProcessThirdStep> = ({}) => {
  return (
    ...
    >
      ...
      <Flex
        flexDir="column"
        backgroundImage="https://images.unsplash.com/photo-1621179917734-429dc196863a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1631&q=80"
